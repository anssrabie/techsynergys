...
function getExtension(number, countryCode) {
 ...
 get the type of the given number e.g. fixed-linemobile
function getNumberType(number, countryCode) {
 ...
 get more info if the validation has failed e.g. too longtoo short
...
function getValidationError(number, countryCode) {
  try {
    ...
    console.log(e);
     ...
     errors are from i18n.phonenumbers.Error in the file httpsgithub.comgooglei18nlibphonenumberblobmasterjavascripti18nphonenumbersphonenumberutil.js
...
function isValidNumber(number, countryCode) {
 ...
 copied this from i18n.phonenumbers.PhoneNumberFormat in the file httpsgithub.comgooglei18nlibphonenumberblobmasterjavascripti18nphonenumbersphonenumberutil.js
var numberFormat = {
  E164 0,
  INTERNATIONAL 1,
  NATIONAL 2,
 ...
 copied this from i18n.phonenumbers.PhoneNumberType in httpsgithub.comgooglei18nlibphonenumberblobmasterjavascripti18nphonenumbersphonenumberutil.js and put the keys in quotes to force closure compiler to preserve the keys
...
var numberType = {
 ...
 copied this from i18n.phonenumbers.PhoneNumberUtil.ValidationResult in httpsgithub.comgooglei18nlibphonenumberblobmasterjavascripti18nphonenumbersphonenumberutil.js and again put the keys in quotes.
var validationError = {
  IS_POSSIBLE 0,
