...
<head>
    ...
    <link rel="apple-touch-icon" href="{{asset('assets/admin/images/ico/32-32V2.png')}}">
    <link rel="shortcut icon"  rel="icon" type="image/x-icon" href="{{asset('assets/admin/images/ico/32-32V2.png')}}">
...
@if(!\Illuminate\Support\Facades\Route::currentRouteNamed('create.news', 'edit.news'))
