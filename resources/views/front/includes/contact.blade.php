    ...
    <form action="{{route('post.contact')}}" method="post" role="form" class="php-email-form" id="cform">
        ...
        <div class="row">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" name="name" class="form-control" id="name" placeholder="{{__('a.your full name')}}">
                <span class="text-danger name_err"></span>
            </div>
            <div class="form-group col-md-6">
                <label>{{__('a.WhatsApp number')}} <span class="text-danger">*</span></label>
                <input class="form-control tele"  type="tel" name="phone_number" id="phone_number">
                <span class="text-danger whats_err"></span>
            </div>

            <div class="form-group col-md-6">
                <label>{{__('a.email address')}}</label>
                <input type="email" class="form-control" name="email" id="email" placeholder="{{__('a.your email address')}}">
                <span class="text-danger email_err"></span>
            </div>
            <div class="form-group col-md-6">
                <label>{{__('a.subject')}} <span class="text-danger">*</span></label>
                <input type="text" class="form-control" name="subject" id="subject" placeholder="{{__('a.The subject of your message')}}">
                <span class="text-danger subject_err"></span>
            </div>
            <div class="form-group">
                <label>{{__('a.message')}} <span class="text-danger">*</span></label>
                <textarea id="message" class="form-control" name="message" rows="5" placeholder="{{__('a.your message')}}"></textarea>
